...
if (isset($_GET['search'])) {
  ...
  $sql = mysqli_query($conn, "SELECT * FROM suggestion_box WHERE nama LIKE '%$search%' OR
  Email LIKE '%$search%'");
    ...
    <section id="contact">
      ...
      <search>
        <form action="" method="GET" class="search-bar">
          <input type="text" placeholder="Cari nama pelanggan di sini" class="search-input" />
        ...
        <tbody>
          ...
          foreach ($pelanggan as $review): ?>
            <tr class="table-data-row">
              ...
              <td class="table-data">
                <img src="images/<?php echo $review['foto'] ?> " alt="foto" width="100px" height="100px"
